...
namespace PlaneTreeNetwork.Hotel.MvcWebUI
{
    public class MvcApplication : System.Web.HttpApplication
    {
        protected void Application_Start()
        {
            ...
            ControllerBuilder.Current.SetControllerFactory(new NinjectControllerFactory(new BusinessModule(),new AutoMapperModule()));//İster Dll(BusinessModule()) --ister Service üzerinden çalışıtrmak için alt yapıyı kurmuş olduk(ServiceModule())
        }

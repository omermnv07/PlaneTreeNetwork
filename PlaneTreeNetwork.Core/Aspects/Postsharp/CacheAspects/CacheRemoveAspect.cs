using PlaneTreeNetwork.Core.CrossCuttingConcerns.Caching;
...
namespace PlaneTreeNetwork.Core.Aspects.Postsharp.CacheAspects
{
    [Serializable]
    public class CacheRemoveAspect : OnMethodBoundaryAspect
    {
        ...
        public override void RuntimeInitialize(MethodBase method)
        {
            ...
            {
                throw new Exception("Yalnış Cache Manager...!");
            }
